    ...
    <footer className="w-full pt-20 pb-10" id="contact">
        <div className="flex flex-col items-center">
            <h1 className="heading lg:max-w-[45vw]">
                Want to take your Digital Security to the  <span className="text-purple"> Next Level?</span>
            </h1>
            <p className=" text-white-200 md:mt-10 my-5 text-center">  
                Reach out and lets discuss how I can assist you and your team in securing your cyber infrastucture
            </p>
