    ...
    >
      ...
      <div className={`h-full`}>
        ...
        >
          ...
          >
            {id === 1 ? <a href="https://github.com/TrayJames/Travaughns-Portfolio/blob/745784432c159eb547b6dd5f54defe2939deff2f/assets/NN_Tra-Vaughn_James_Resume.pdf" target="_blank"> {title}</a> : title}
